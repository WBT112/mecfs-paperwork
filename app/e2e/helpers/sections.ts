...
export const getCollapsibleSectionToggleById = (
  page: Page,
  sectionId: string,
) => page.locator(`#${sectionId}-toggle`);

export const openCollapsibleSectionById = async (
  page: Page,
  sectionId: string,
) => {
  const toggle = getCollapsibleSectionToggleById(page, sectionId);
