...
console.log('🔄 Syncing sponsor funding URL...');
console.log(
...
const sponsorUrl = resolveSponsorUrl(fundingEntries);

const outputContents =
  `// This file is generated by scripts/sync-funding.mjs. Do not edit.\n` +
  `export const FUNDING_URL: string | null = ${JSON.stringify(sponsorUrl)};\n`;

await writeFile(outputPath, outputContents, 'utf8');

console.log(`${C_GREEN}✔ Sponsor funding URL synced.${C_RESET}`);
