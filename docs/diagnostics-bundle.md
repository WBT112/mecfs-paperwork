...
The diagnostics bundle is a privacy-safe metadata export designed for troubleshooting and issue reproduction. It contains **only technical metadata** — never personal or medical data.

## How to create a diagnostics bundle

1. Navigate to the **Help** page (`/help`).
2. Scroll to the **Tools & Diagnostics** section.
3. Click **"Diagnosepaket erstellen"** (or "Create diagnostics bundle" in English).
4. A JSON file (`mecfs-diagnostics.json`) will be downloaded.
5. Alternatively, click **"Diagnose kopieren"** to copy the diagnostics to your clipboard.
